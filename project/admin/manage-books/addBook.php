<?php
    ...
    if(isset($_POST['btnAddBook'])) 
    {
        function generateISBN() 
        {
          ...
          return $prefix.$six_digit_random_number;
        }
                ...
                <div class="px-6 py-4">
                    ...
                    <form method="post" class="my-8 grid grid-cols-12 gap-x-2">
                        ...
                        <div class="col-span-full flex items-center justify-end mt-6">
                            <button name="btnAddBook" class="px-6 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                Add Book
                            </button>
